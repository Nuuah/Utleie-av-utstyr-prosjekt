...
@WebServlet(name = "FramtidigeReservasjoner", value = "/FramtidigeReservasjoner")
public class FramtidigeReservasjoner extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<p> Oversikt over reservasjoner per ansatt for neste seks måneder </p>");
        ...
        try {
            framtidigeReservasjoner = DAOlist.listFramtidigeReservasjoner(out);
        } catch (Exception e) {
            e.printStackTrace();
        }


        assert framtidigeReservasjoner != null;
        ...
        ListIterator<ReservasjonModel> iteratoren = framtidigeReservasjoner.listIterator();
